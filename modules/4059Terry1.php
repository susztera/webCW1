...
<div class="container-md bg-light h-100">
    <div class="container in-text">
        <h1 class="display-4">4059CEM</h1>
        <form>
            <div class="mb-3">
                <label for="CW1" class="form-label">Coursework</label>
                <div class="input-group">
                    <input type="number" class="form-control tidy-input" id="CW1" min="0" max="100">
                    <div class="input-group-text">%</div>
                </div>
                <div id="help" class="form-text">This is a module with only one Coursework... Feel free to check
                    anyway...
                </div>
            </div>
