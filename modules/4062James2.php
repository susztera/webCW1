...
<div class="container-md bg-light h-100">
    <div class="container in-text">
        <h1 class="display-4">4062CEM</h1>
        <form>
            <div class="mb-3">
                <label for="Test" class="form-label">Test</label>
                <div class="input-group">
                    <input type="number" class="form-control tidy-input" id="Test" min="0" max="100">
                    <div class="input-group-text">%</div>
                </div>
                <div id="help" class="form-text">This is a module with only one Test... Feel free to check anyway...
                </div>
            </div>
