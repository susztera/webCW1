...
<div class="container-md bg-light h-100">
    <div class="container in-text">
        ...
        <form>
            ...
            <div class="mb-3">
                <label for="PT1" class="form-label">Phase Test 1</label>
                <div class="input-group">
                    <input type="number" class="form-control tidy-input" id="PT1" min="0" max="100">
                    <div class="input-group-text">%</div>
                </div>
            </div>
            <div class="mb-3">
                <label for="PT2" class="form-label">Phase Test 2</label>
                <div class="input-group">
                    <input type="number" class="form-control tidy-input" id="PT2" min="0" max="100">
                    <div class="input-group-text">%</div>
                </div>
            </div>
            <div class="mb-3">
                <label for="TCA" class="form-label">TCA</label>
                <div class="input-group">
                    <input type="number" class="form-control tidy-input" id="TCA" min="0" max="100">
                    <div class="input-group-text">%</div>
                </div>
            </div>
