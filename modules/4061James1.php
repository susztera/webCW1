...
<div class="container-md bg-light h-100">
    <div class="container in-text">
        ...
        <form id="formy">
            ...
            <div class="mb-3">
                <label for="CW2" class="form-label">Coursework 2</label>
                <div class="input-group">
                    <input type="number" class="form-control tidy-input" id="CW2" min="0" max="100">
                    <div class="input-group-text">%</div>
                </div>
            </div>
            <button type="button" class="btn btn-outline-dark" onclick="james()">Calculate</button>
        </form>
...
<script>
    function james() {
        ...
        let y = document.getElementById('formy').elements['CW2'].value;
        let percent = (10 * Number(x) + 20 * Number(y)) / 30;
